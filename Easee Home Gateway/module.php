		...
		foreach($requests as $request) {
			...
			switch($function) {
				...
				case 'getchargersite':
					...
					$this->ExecuteEaseeRequest($childId, 'GetChargerSite', array($request->ChargerId));
					break;
				...
				case 'enablecharger':
					...
					$this->ExecuteEaseeRequest($childId, 'EnableCharger', array($request->ChargerId, $request->State));
					break;
